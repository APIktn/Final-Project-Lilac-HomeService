...
//   React.useEffect(() => {
//     // Fetch data again if necessary whenever status changes
//     // e.g., fetchTechnicians();
//   }, [status]);
...
//     await handleStatusChange("กำลังดำเนินการ");
//   };
...
//   React.useEffect(() => {
//     // Re-fetch data or trigger updates when status changes if needed
//     // Example: refetch technician list or any additional data if needed
//     console.log("Status has changed to:", status);
//     // Optionally, you can re-fetch data or update other states here
//   }, [status]);
...
//     // Re-fetch any necessary data or trigger updates here
//   };
