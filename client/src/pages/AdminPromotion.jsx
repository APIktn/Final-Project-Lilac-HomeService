...
function AdminPromotion() {
  ...
  const filterPromotionCodes = () => {
    ...
    if (filterStatus !== "all") {
      filteredPromotionCodes = filteredPromotionCodes.filter((code) => {
        if (filterStatus === "🎉 โค้ดหมดแล้ว") return code.is_active === false && code.limitation === true;
        if (filterStatus === "✅ โค้ดใช้งานได้") return code.is_active === true;
        if (filterStatus === "❌ โค้ดหมดอายุ") return !code.is_active && !code.limitation;
        return true;
      });
    }
 ...
 <div className="flex justify-between p-4 ml-5">
  <button
    className={`py-2 px-4 rounded-md  ${
      filterStatus === "all" ? " text-[#336DF2] bg-blue-100 border-solid border-2 border-[#336DF2] " :
      filterStatus === "🎉 โค้ดหมดแล้ว" ? " text-yellow-500 bg-yellow-100 border-solid border-2 border-yellow-500" :
      filterStatus === "✅ โค้ดใช้งานได้" ? " text-green-500 bg-green-100 border-solid border-2 border-green-500" :
      filterStatus === "❌ โค้ดหมดอายุ" ? " text-red-600 bg-red-100 border-solid border-2 border-red-600" :
      "bg-white text-[#336DF2]"
    }`}   
    onClick={() => setFilterStatus(
      filterStatus === "all" ? "✅ โค้ดใช้งานได้" :
      filterStatus === "✅ โค้ดใช้งานได้" ? "❌ โค้ดหมดอายุ" :
      filterStatus === "❌ โค้ดหมดอายุ" ? "🎉 โค้ดหมดแล้ว" :
      "all"
    )}
  >
    {filterStatus === "all" ? "💷 ทั้งหมด" :
     filterStatus === "🎉 โค้ดหมดแล้ว" ? "🎉 โค้ดหมดแล้ว" :
     filterStatus === "✅ โค้ดใช้งานได้" ? "✅ โค้ดใช้งานได้" :
     "❌ โค้ดหมดอายุ"
    }
  </button>
</div>
