            ...
            <div className="bg-white p-4 rounded-md shadow-md rounded-t-none h-[500px]">
              <div className="bg-white p-4 rounded-md h-[300px]">
                <div className="flex items-center mt-[30px]">
                  <div className="w-[205px] text-[#646C80]">Promotion Code</div>
                ...
                <div className="flex items-center mt-[30px]">
                  <div className="w-[205px] text-[#646C80]">โควต้าการใช้</div>
                ...
                <div className="flex items-center mt-[30px]">
                  ...
                  <div className="w-[433px] ">
                    {dayjs(promotion.expired_date).format("DD/MM/YYYY HH:mm A")}
                  </div>
                </div>
                ...
                <div className="flex flex-col gap-7 border-t border-[#CCD0D7] mb-4 mt-10 pb-4 h-[100px]  pt-10 bg-white">
                  <div className="flex">
                    ...
                    <p>
                      {dayjs(promotion.created_at).format("DD/MM/YYYY HH:mm A")}
                    </p>
                  </div>
                  <div className="flex">
                    <div className="w-[205px] text-[#646C80]">แก้ไขล่าสุด</div>
                    <p>
                      {dayjs(promotion.updated_at).format("DD/MM/YYYY HH:mm A")}
                    </p>
                  </div>
                </div>
              </div>
